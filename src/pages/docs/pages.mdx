...
Create a new page with the `yarn page` command:
...
- `date` *(string parsable by [day.js](https://day.js.org/))* — default sorting mechanism for [`pagesWithTag`](https://github.com/bensmithett/tropical/blob/HEAD/src/utils.js) (see below)
