...
One obvious use is creating collections of pages — for example, a date-ordered collection that includes blog posts but not your homepage page. Tropical provides a `pagesWithTag` helper for this common scenario.
