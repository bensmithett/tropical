...
These 4 small files in the `app` directory are the heart of San Blas. They're heavily commented, so I encourage you to read them, understand what's happening and make changes to suit your needs!
